...
var AccountsComponent = (function () {
    function AccountsComponent() {
        ...
        this.dataSource = new __WEBPACK_IMPORTED_MODULE_1__angular_material__["d" /* MatTableDataSource */](this.accountData);
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__hours_hours_component__ = __webpack_require__("../../../../../src/app/hours/hours.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__sprints_sprints_component__ = __webpack_require__("../../../../../src/app/sprints/sprints.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__userstories_userstories_component__ = __webpack_require__("../../../../../src/app/userstories/userstories.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__accounts_accounts_component__ = __webpack_require__("../../../../../src/app/accounts/accounts.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__data_data_component__ = __webpack_require__("../../../../../src/app/data/data.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__manual_manual_component__ = __webpack_require__("../../../../../src/app/manual/manual.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__account_self_account_self_component__ = __webpack_require__("../../../../../src/app/account-self/account-self.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__services_employee_service__ = __webpack_require__("../../../../../src/app/services/employee.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__projects_add_project_add_project_component__ = __webpack_require__("../../../../../src/app/projects/add-project/add-project.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__projects_edit_project_edit_project_component__ = __webpack_require__("../../../../../src/app/projects/edit-project/edit-project.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["K" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_12__hours_hours_component__["a" /* HoursComponent */],
                __WEBPACK_IMPORTED_MODULE_13__projects_projects_component__["a" /* ProjectsComponent */],
                __WEBPACK_IMPORTED_MODULE_14__sprints_sprints_component__["a" /* SprintsComponent */],
                __WEBPACK_IMPORTED_MODULE_15__userstories_userstories_component__["a" /* UserstoriesComponent */],
                __WEBPACK_IMPORTED_MODULE_16__accounts_accounts_component__["a" /* AccountsComponent */],
                __WEBPACK_IMPORTED_MODULE_17__customers_customers_component__["a" /* CustomersComponent */],
                __WEBPACK_IMPORTED_MODULE_18__data_data_component__["a" /* DataComponent */],
                __WEBPACK_IMPORTED_MODULE_19__manual_manual_component__["a" /* ManualComponent */],
                __WEBPACK_IMPORTED_MODULE_20__account_self_account_self_component__["a" /* AccountSelfComponent */],
                ...
                __WEBPACK_IMPORTED_MODULE_26__projects_add_project_add_project_component__["a" /* AddProjectComponent */],
                __WEBPACK_IMPORTED_MODULE_27__projects_edit_project_edit_project_component__["a" /* EditProjectComponent */]
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_22__services_project_service__["a" /* ProjectService */],
                __WEBPACK_IMPORTED_MODULE_24__services_auth_service__["a" /* AuthService */],
                __WEBPACK_IMPORTED_MODULE_23__services_employee_service__["a" /* EmployeeService */]],
...
var CustomersComponent = (function () {
    function CustomersComponent() {
        ...
        this.dataSource = new __WEBPACK_IMPORTED_MODULE_1__angular_material__["d" /* MatTableDataSource */](this.customerData);
    }
...
var HomeComponent = (function () {
    function HomeComponent(http, router, auth) {
        this.http = http;
        this.router = router;
        this.auth = auth;
    ...
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_http__["b" /* Http */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */], __WEBPACK_IMPORTED_MODULE_4__services_auth_service__["a" /* AuthService */]])
    ], HomeComponent);
...
var HoursComponent = (function () {
    function HoursComponent() {
        ...
        this.dataSource = new __WEBPACK_IMPORTED_MODULE_1__angular_material__["d" /* MatTableDataSource */](this.entryData);
    }
...
module.exports = "<img src='../assets/images/web.png' alt='logo'>\n<div class=\"container\">\n    <div class=\"col-sm-6\">\n        <h3 class=\"display-3\"><i class=\"fa fa-user-circle-o\" aria-hidden=\"true\"></i></h3>\n        <br>\n        <div class=\"form-group\">\n            <mat-form-field>\n            <input matInput #email placeholder=\"Enter your email\" [formControl]=\"email_input\" required>\n            <mat-error *ngIf=\"email_input.invalid\">{{getErrorMessage()}}</mat-error>\n            </mat-form-field>\n        </div>\n        <div class=\"form-group\">\n        <mat-form-field>\n            <input matInput #password placeholder=\"Enter your password\" [type]=\"hide ? 'text' : 'password'\">\n            <mat-icon matSuffix (click)=\"hide = !hide\">{{hide ? 'visibility' : 'visibility_off'}}</mat-icon>\n        </mat-form-field>\n    </div>\n    <button type=\"button\" (click)=\"checkLogin(email.value, password.value)\" class=\"btn btn-success\">Login</button>\n</div>\n  "
...
var LoginComponent = (function () {
    function LoginComponent(router, employeeService, auth, iconRegistry, sanitizer) {
        this.router = router;
        this.employeeService = employeeService;
        this.auth = auth;
        this.email_input = new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["b" /* FormControl */]('', [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["j" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["j" /* Validators */].email]);
        ...
        iconRegistry.addSvgIcon('password_visible', sanitizer.bypassSecurityTrustResourceUrl('assets/password_visible.svg'));
    }
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */], __WEBPACK_IMPORTED_MODULE_2__services_employee_service__["a" /* EmployeeService */], __WEBPACK_IMPORTED_MODULE_3__services_auth_service__["a" /* AuthService */],
            __WEBPACK_IMPORTED_MODULE_5__angular_material__["b" /* MatIconRegistry */], __WEBPACK_IMPORTED_MODULE_6__angular_platform_browser__["c" /* DomSanitizer */]])
    ], LoginComponent);
...
module.exports = "<div class=\"container\">\n  <mat-form-field class=\"\" style=\"margin-top: 20px\">\n    <input matInput #project_name placeholder=\"Name\">\n  </mat-form-field><br>\n  <mat-form-field class=\"\">\n    <input matInput #project_description placeholder=\"Project Description\">\n  </mat-form-field><br>\n  <mat-form-field class=\"\">\n    <input matInput #customer_fk placeholder=\"Customer ID\">\n  </mat-form-field><br>\n    <button (click)=\"insertNewProject(project_name.value, project_description.value, customer_fk.value); openSnackBar()\" class=\"primary\">Submit</button>\n</div>\n"
...
var AddProjectComponent = (function () {
    function AddProjectComponent(projectService, snackBar) {
        this.projectService = projectService;
        this.snackBar = snackBar;
    }
    AddProjectComponent.prototype.insertNewProject = function (project_name, project_description, customer_fk) {
        this.projectService.insertNewProject(project_name, project_description, customer_fk).subscribe();
    };
    AddProjectComponent.prototype.openSnackBar = function () {
    ...
    AddProjectComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            template: __webpack_require__("../../../../../src/app/projects/add-project/add-project.component.html"),
            styles: [__webpack_require__("../../../../../src/app/projects/add-project/add-project.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_project_service__["a" /* ProjectService */], __WEBPACK_IMPORTED_MODULE_2__angular_material__["c" /* MatSnackBar */]])
    ], AddProjectComponent);
...
module.exports = "<div class=\"container\">\n  <mat-form-field class=\"\" style=\"margin-top: 20px\">\n    <input matInput #project_name placeholder=\"Project Name\">\n  </mat-form-field><br>\n  <mat-form-field class=\"\">\n    <input matInput #project_description placeholder=\"Project Description\">\n  </mat-form-field><br>\n  <mat-form-field class=\"\">\n    <input matInput #customer_fk placeholder=\"Customer ID\">\n  </mat-form-field><br>\n    <button (click)=\"insertNewProject(project_name.value, project_description.value, customer_fk.value); openSnackBar()\" class=\"primary\">Submit</button>\n</div>"
...
var EditProjectComponent = (function () {
    ...
    EditProjectComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            template: __webpack_require__("../../../../../src/app/projects/edit-project/edit-project.component.html"),
            styles: [__webpack_require__("../../../../../src/app/projects/edit-project/edit-project.component.css")]
        }),
        __metadata("design:paramtypes", [])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__projects_add_project_add_project_component__ = __webpack_require__("../../../../../src/app/projects/add-project/add-project.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: 'add_project', component: __WEBPACK_IMPORTED_MODULE_14__projects_add_project_add_project_component__["a" /* AddProjectComponent */] },
...
var AuthService = (function () {
    ...
    AuthService.prototype.createAuthHeader = function (email, password) {
    ...
    AuthService.prototype.storeAuthorization = function (email, password, local) {
        var authorization = {
            email: email,
            password: password
        };
...
var EmployeeService = (function () {
    ...
    EmployeeService.prototype.goHome = function () {
        this.router.navigate(['home']);
    };
    EmployeeService.prototype.login = function (email, password) {
        var _this = this;
        var headers = this.auth.createAuthHeader(email, password);
        this.http.get("http://localhost:8080/api/login/", { headers: headers }).subscribe(function (res) {
    ...
    EmployeeService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */], __WEBPACK_IMPORTED_MODULE_2__angular_http__["b" /* Http */]])
    ], EmployeeService);
...
var ProjectService = (function () {
    function ProjectService(http) {
        ...
        this.INSERT_PROJECT = 'http://localhost:8080/api/projects/create/url';
        this.body = {};
    }
    ProjectService.prototype.insertNewProject = function (name, description, customer_fk) {
        return this.http.post(this.INSERT_PROJECT, this.body, {
            params: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpParams */]().set('name', name).set('description', description).set('custid', customer_fk)
        });
    };
...
var SprintsComponent = (function () {
    function SprintsComponent() {
        ...
        this.dataSource = new __WEBPACK_IMPORTED_MODULE_1__angular_material__["d" /* MatTableDataSource */](this.sprintData);
    }
...
var UserstoriesComponent = (function () {
    function UserstoriesComponent() {
        ...
        this.dataSource = new __WEBPACK_IMPORTED_MODULE_1__angular_material__["d" /* MatTableDataSource */](this.userstoryData);
    }
